...
class CurrencyData {
  ...
  static String availableCurrencies = "[\"CAD\",\"HKD\",\"ISK\",\"PHP\",\"DKK\",\"HUF\",\"CZK\",\"AUD\",\"RON\",\"SEK\",\"IDR\",\"INR\",\"BRL\",\"RUB\",\"HRK\",\"JPY\",\"THB\",\"CHF\",\"SGD\",\"PLN\",\"BGN\",\"TRY\",\"CNY\",\"NOK\",\"NZD\",\"ZAR\",\"USD\",\"MXN\",\"ILS\",\"GBP\",\"KRW\",\"MYR\"]";
  ...
  static List getCurrencySymbolData(String currShortCode) {
    var currencyDatas = jsonDecode(currencyInfo);
    List shortcodeData = new List(2);
    shortcodeData[0] = "";
    shortcodeData[1] = "";
